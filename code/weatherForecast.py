...
for row in resultsLocations:
    locationNames.append(row.locationName)
    shortNames.append(row.shortName)
    cities.append(row.city)
    latitudes.append(row.latitude)
    longitudes.append(row.longitude)


for idx,location in enumerate(locationNames):
    lat = latitudes[idx]
    lon = longitudes[idx]
    city = cities[idx]
    shortName = shortNames[idx]
    print(f"Location: {locationNames[idx]} shortName: {shortNames[idx]}")
