...
SELECT * FROM "dailyForecastTB" ORDER BY "id" ASC, "responseNumber" ASC, "retrievalDateTime" ASC;
...
$$  
BEGIN  
	INSERT INTO "histDailyForecastTB"("responseNumber", "responseName", "city", "shortName", "latitude", "longitude", "startDateTime", 
	 ...
	 VALUES(NEW."responseNumber", NEW."responseName", NEW."city", new."shortName", NEW."latitude", NEW."longitude", NEW."startDateTime", 
...
$$  
BEGIN  
	INSERT INTO "histHourlyForecastTB"("responseNumber", "city", "shortName", "latitude", "longitude", "startDateTime", "startDate", "startTime",		
	 ...
	 VALUES(NEW."responseNumber", NEW."city", NEW."shortName", NEW."latitude", NEW."longitude", NEW."startDateTime", NEW."startDate", NEW."startTime",		
